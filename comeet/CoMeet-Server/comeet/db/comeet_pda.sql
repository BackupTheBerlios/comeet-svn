...
CREATE TABLE mensajes (
    ...
    fecha_confirmacion date DEFAULT '1900-01-01'::date NOT NULL,
    hora_confirmacion time without time zone DEFAULT '00:00:00'::time without time zone NOT NULL
);
...
--
-- Name: roles_rid_seq; Type: SEQUENCE SET; Schema: public; Owner: comeetadmin
--
...
--
-- Name: tipo_grupo_id_tipo_seq; Type: SEQUENCE SET; Schema: public; Owner: comeetadmin
--
...
--
-- Data for Name: mensajes_pda; Type: TABLE DATA; Schema: public; Owner: comeetadmin
--

COPY mensajes_pda (mid, login, gid_origen, fecha_envio, hora_envio, asunto, texto, confirmado, fecha_confirmacion, hora_confirmacion, entregado) FROM stdin;
...
--
-- Name: grupos_nombre_key; Type: CONSTRAINT; Schema: public; Owner: comeetadmin; Tablespace: 
--
...
--
-- Name: tipo_grupo_id_tipo_key; Type: CONSTRAINT; Schema: public; Owner: comeetadmin; Tablespace: 
--
...
--
-- Name: ubicaciones_pkey; Type: CONSTRAINT; Schema: public; Owner: comeetadmin; Tablespace: 
--
...
--
-- Name: usuarios_rol_fkey; Type: FK CONSTRAINT; Schema: public; Owner: comeetadmin
--

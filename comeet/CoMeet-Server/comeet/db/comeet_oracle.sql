--------------------------------------------------------
--  File created - Sunday-November-02-2008   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MENSAJES_MID_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 109 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence MENSAJES_PDA_MID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MENSAJES_PDA_MID_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 6 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence ROLES_RID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "ROLES_RID_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 25 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into MENSAJES (MID,UID_DESTINO,FECHA_ENVIO,ASUNTO,TEXTO,CONFIRMADO,TIEMPO_VIDA,UID_ORIGEN,CONTROL,MINUTOS,FECHA_CONFIRMACION,HORA_ENVIO,HORA_CONFIRMACION) values (81,4,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'mensaje 1','prueba 1',1,3,1,0,0,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'17:08:26 PM','17:08:39 PM');
Insert into MENSAJES (MID,UID_DESTINO,FECHA_ENVIO,ASUNTO,TEXTO,CONFIRMADO,TIEMPO_VIDA,UID_ORIGEN,CONTROL,MINUTOS,FECHA_CONFIRMACION,HORA_ENVIO,HORA_CONFIRMACION) values (82,4,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'mensaje 2','prueba 2',1,3,1,0,0,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'17:08:37 PM','17:08:40 PM');
Insert into MENSAJES (MID,UID_DESTINO,FECHA_ENVIO,ASUNTO,TEXTO,CONFIRMADO,TIEMPO_VIDA,UID_ORIGEN,CONTROL,MINUTOS,FECHA_CONFIRMACION,HORA_ENVIO,HORA_CONFIRMACION) values (83,4,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'prueba de concepto','12345',1,3,1,0,0,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'17:10:17 PM','17:10:39 PM');
Insert into MENSAJES (MID,UID_DESTINO,FECHA_ENVIO,ASUNTO,TEXTO,CONFIRMADO,TIEMPO_VIDA,UID_ORIGEN,CONTROL,MINUTOS,FECHA_CONFIRMACION,HORA_ENVIO,HORA_CONFIRMACION) values (84,5,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'prueba de concepto','12345',0,3,1,0,0,to_timestamp('01-JAN-50 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'17:10:17 PM','00:00:00 AM');
Insert into MENSAJES (MID,UID_DESTINO,FECHA_ENVIO,ASUNTO,TEXTO,CONFIRMADO,TIEMPO_VIDA,UID_ORIGEN,CONTROL,MINUTOS,FECHA_CONFIRMACION,HORA_ENVIO,HORA_CONFIRMACION) values (85,4,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'hola mundo','hola mundo!',1,3,1,0,0,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'18:55:01 PM','18:55:02 PM');
Insert into MENSAJES (MID,UID_DESTINO,FECHA_ENVIO,ASUNTO,TEXTO,CONFIRMADO,TIEMPO_VIDA,UID_ORIGEN,CONTROL,MINUTOS,FECHA_CONFIRMACION,HORA_ENVIO,HORA_CONFIRMACION) values (86,5,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'hola mundo','hola mundo!',0,3,1,0,0,to_timestamp('01-JAN-50 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'18:55:01 PM','00:00:00 AM');
Insert into MENSAJES (MID,UID_DESTINO,FECHA_ENVIO,ASUNTO,TEXTO,CONFIRMADO,TIEMPO_VIDA,UID_ORIGEN,CONTROL,MINUTOS,FECHA_CONFIRMACION,HORA_ENVIO,HORA_CONFIRMACION) values (87,4,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'estoy usando puntuación','qué pasa si incluyo ortografía?',1,3,1,0,0,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'19:01:41 PM','19:01:44 PM');
Insert into MENSAJES (MID,UID_DESTINO,FECHA_ENVIO,ASUNTO,TEXTO,CONFIRMADO,TIEMPO_VIDA,UID_ORIGEN,CONTROL,MINUTOS,FECHA_CONFIRMACION,HORA_ENVIO,HORA_CONFIRMACION) values (89,4,to_timestamp('02-NOV-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'concept','my concept',1,3,1,0,0,to_timestamp('02-NOV-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'11:28:28 AM','11:28:32 AM');
Insert into MENSAJES (MID,UID_DESTINO,FECHA_ENVIO,ASUNTO,TEXTO,CONFIRMADO,TIEMPO_VIDA,UID_ORIGEN,CONTROL,MINUTOS,FECHA_CONFIRMACION,HORA_ENVIO,HORA_CONFIRMACION) values (88,4,to_timestamp('01-NOV-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'saludo','hola, necesito que vengas a la oficina',1,3,1,0,0,to_timestamp('01-NOV-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'16:47:50 PM','16:47:58 PM');
...
Insert into MENSAJES_PDA (MID,LOGIN_DESTINO,GID_ORIGEN,FECHA_ENVIO,ASUNTO,TEXTO,CONFIRMADO,FECHA_CONFIRMACION,ENTREGADO,HORA_ENVIO,HORA_CONFIRMACION) values (5,'suba',3,to_timestamp('26-OCT-08 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'hola mundo','hola mundo!


',0,to_timestamp('01-JAN-50 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),0,'06:55 PM','00:00 AM');
...
Insert into ROLES (RID,NOMBRE) values (5,'CORREO');
...
Insert into TRANSACCIONES (CODIGO,DESCRIPCION,DRIVER,ARGS) values ('TR013','Confirma Mensaje PDA','com.kazak.comeet.server.businessrules.MessageConfirmer','<root>
 <args>UPD0003A</args>
</root>');
...
Insert into USUARIOS (CODIGO,LOGIN,CLAVE,NOMBRES,CORREO,HABILITADO,GID,ROL) values (2,'auditor','827ccb0eea8a706c4c34a16891f84e7b','Usuario Auditor 01','xtingray@localhost',1,4,2);

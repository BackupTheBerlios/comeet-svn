--------------------------------------------------------
--  File created - jueves-noviembre-13-2008   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Sequence GRUPOS_GID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "GRUPOS_GID_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 16 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence MENSAJES_MID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MENSAJES_MID_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 123 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence MENSAJES_PDA_MID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MENSAJES_PDA_MID_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "UBICACIONES_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 36 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence USUARIOS_UID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "USUARIOS_UID_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 18 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into MENSAJES_PDA (MID,LOGIN_DESTINO,GID_ORIGEN,FECHA_ENVIO,ASUNTO,TEXTO,CONFIRMADO,FECHA_CONFIRMACION,ENTREGADO,HORA_ENVIO,HORA_CONFIRMACION) values (20.'000007'.4.to_timestamp('12/11/08 12:00:00,000000000 AM','DD/MM/RR HH12:MI:SS,FF AM').'bullet 2'.'never mind!


'.0.to_timestamp('01/01/50 12:00:00,000000000 AM','DD/MM/RR HH12:MI:SS,FF AM').0.'11:47 PM'.'00:00 AM');
...
Insert into USUARIOS (CODIGO,LOGIN,CLAVE,NOMBRES,CORREO,HABILITADO,GID,ROL) values (11.'prueba02'.'827ccb0eea8a706c4c34a16891f84e7b'.'Prueba 02'.'prueba02@localhost'.1.3.5);
Insert into USUARIOS (CODIGO,LOGIN,CLAVE,NOMBRES,CORREO,HABILITADO,GID,ROL) values (9.'mensajero'.'827ccb0eea8a706c4c34a16891f84e7b'.'Mensajero Gerencia'.'mensajero@localhost'.1.3.5);
Insert into USUARIOS (CODIGO,LOGIN,CLAVE,NOMBRES,CORREO,HABILITADO,GID,ROL) values (10.'prueba01'.'827ccb0eea8a706c4c34a16891f84e7b'.'Usuario Prueba'.'prueba@localhost'.1.3.1);
Insert into USUARIOS (CODIGO,LOGIN,CLAVE,NOMBRES,CORREO,HABILITADO,GID,ROL) values (12.'prueba03'.'827ccb0eea8a706c4c34a16891f84e7b'.'Prueba 03'.'prueba03@localhost'.1.3.1);
Insert into USUARIOS (CODIGO,LOGIN,CLAVE,NOMBRES,CORREO,HABILITADO,GID,ROL) values (13.'secretaria'.'827ccb0eea8a706c4c34a16891f84e7b'.'Secretaria Gerencia'.'secretaria@localhost'.1.3.5);
...
Insert into USUARIOS (CODIGO,LOGIN,CLAVE,NOMBRES,CORREO,HABILITADO,GID,ROL) values (3.'suba'.'827ccb0eea8a706c4c34a16891f84e7b'.'Lote Suba'.'soporte@localhost'.1.13.4);
...
Insert into USUARIOS (CODIGO,LOGIN,CLAVE,NOMBRES,CORREO,HABILITADO,GID,ROL) values (17.'raul'.'827ccb0eea8a706c4c34a16891f84e7b'.'Raul Gutierrez'.'raul@katana'.1.3.1);

...
/** 
* Escribe la funciï¿½n de calcular el precio de un grupo de radicados a enviar
* @return   string
*/		
function javascriptCalcularPrecio($l, $n, $g1, $g2)
{
	...
	echo "peso = (document.getElementById('envio_peso').value)*1;\n\t";
	if ($l >0 || $n>0)
...
*/		
	...
	/** 
* Obtiene el primer radicado Internacional grupo 1 de un grupo. Antes de invocar esta funciï¿½n debe llamarse a obtenerGrupo()  y a getNumNacionalesLocales()
* @return   string
*/			
...
/** 
* Obtiene el primer radicado Internacional grupo 2 de un grupo. Antes de invocar esta funciï¿½n debe llamarse a obtenerGrupo()  y a getNumNacionalesLocales()
* @return   string
*/		

...
if ($db)
{
	...
	if (isset($_POST['btn_accion']))
	{
		...
		//$record['SGD_TRAD_DIASBLOQUEO'] = $_POST['txt_diasb'];
	...
	$sql =	"SELECT SGD_TRAD_CODIGO as ID, SGD_TRAD_DESCR as NOMB, 
					SGD_TRAD_GENRADSAL as GRS, SGD_TRAD_DIASBLOQUEO as DBLOQ 
...
{	$cad = '<tr bordercolor="#FFFFFF">
	...
	{	case 1:	//NO CONECCION A BD
		...
		case 3:	//ACUTALIZACION REALIZADA
				$cad .= "Informacion actualizada!!";break;
		case 4:	//INSERCION REALIZADA
				$cad .= "Registro creado satisfactoriamente!!";break;
		case 5:	//IMPOSIBILIDAD DE ELIMINAR ESP, TIENE HISTORIAL, ESTA LIGADO CON RADICADOS EXISTENTES
				$cad .= "No se puede eliminar registro, se encuentra ligado a radicados existentes.";break;
	}
	$cad .= '</td></tr>';
}
?>
	...
	{	
		...
		{	if (busca(cual) === false)
			{	if(isWhitespace(document.form1.txtnombre.value))
				...
				/*
				if (!(isNonnegativeInteger(document.form1.txt_diasb.value)))
				{
					alert('Dias de bloqueo debe ser numerica y positiva');
					flag = false;
				}
				*/
			}
...
<tr class=timparr>
	...
	<td class="listado2" height="1" colspan="3">
		...
		<tr>
			...
			<td width="10%" align="center"><input type="radio" value="1" name="grpRad" onclick="ver_datos(this.value)"></td>
			<td width="10%" align="center"><input type="radio" value="2" name="grpRad" onclick="ver_datos(this.value)"></td>
...
<tr>
	...
	<!--
	<td class="titulos2" height="26">D&iacute;as Bloqueo</td>
	<td class="listado2">
		<input type="text" name="txt_diasb" id="txt_diasb" size="2" maxlength="2" />
	</td>
	-->
</tr>
<?PHP echo $cad ?>

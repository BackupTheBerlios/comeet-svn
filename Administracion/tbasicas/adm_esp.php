		...
		{	Case 'Agregar':
			...
			Case 'Eliminar':
				{	$ADODB_COUNTRECS = true;
					...
					{	$db->conn->BeginTrans();
						$ok = $conn->Execute('DELETE FROM BODEGA_EMPRESAS WHERE IDENTIFICADOR_EMPRESA=?',$record['IDENTIFICADOR_EMPRESA']);
...
{	echo '<tr bordercolor="#FFFFFF">
	...
	{	case 1:	//NO CONECCION A BD
		...
		case 4:	//INSERCION REALIZADA
				echo "ESP creada satisfactoriamente!!";break;
		case 5:	//IMPOSIBILIDAD DE ELIMINAR ESP, TIENE HISTORIAL, ESTÁ LIGADO CON DIRECCIONES
				echo "No se puede eliminar ESP, se encuentra ligado a direcciones.";break;
	}
	echo '</td></tr>';
}
?>

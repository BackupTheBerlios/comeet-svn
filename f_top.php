...
<table width="100%" height="76"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="62"><a href="./Manuales/ayudaorfeo/content.htm" target="Ayuda_Orfeo" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','imagenes/overAyuda.gif',1)"><img src="imagenes/ayuda.gif" name="Image8" width="62" height="76" border="0" title="MANUAL ORFEO" ALT='Ayuda'></a></td>
    <td width="61"><a href="mod_datos.php?<?=session_name()."=".session_id()."&fechah=$fechah&krd=$krd&info=false"?>" target=mainFrame onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image9','','imagenes/overInfo.gif',1)"><img src="imagenes/info.gif" name="Image9" width="61" height="76" border="0"></a></td>
    <td width="61"><a href="menu/creditos.php?<?=session_name()."=".session_id()."&fechah=$fechah&krd=$krd&info=false"?>" target=mainFrame onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image12','','imagenes/overCreditos.gif',1)"><img src="imagenes/creditos.gif" name="Image12" width="61" height="76" border="0"></a></td>
    <td width="63">
    <?php

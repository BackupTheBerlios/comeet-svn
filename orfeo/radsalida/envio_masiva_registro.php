...
$isql = "UPDATE SGD_RENV_REGENVIO
			...
			", sgd_fenv_codigo='$empresa_envio', sgd_renv_fech = ".$db->conn->sysTimeStamp.
		" WHERE sgd_renv_planilla = '00' and sgd_renv_tipo = 1
			and radi_nume_grupo = $grupo and
			radi_nume_sal not in (select sgd_rmr_radi from sgd_rmr_radmasivre where sgd_rmr_grupo=$grupo) ";

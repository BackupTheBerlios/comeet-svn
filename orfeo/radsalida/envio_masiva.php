<?
//Programa ue genera el formulario de selección de opciones para el envío de un grupo de documentos de radicación masiva
	error_reporting(7);
    session_start();
	$ruta_raiz = "..";
	...
	//var arreglo que  almacena el númeo de radicados nacionales y locales
	//print("La territorial del envio es...($codTerrEnvio)-".$terrEnvio['dpto_codi']."--".$terrEnvio['muni_codi']);
...
if (document.form1.empresa_envio.value!='null' && isInteger(document.form1.envio_peso.value)){
	...
	alert ('Debe suministrar los datos de la empresa de envío y el peso de los documentos');
	return;
}
...
if (document.form1.observaciones.value.length>1 && document.form1.planilla.value.length>1){
	...
	alert ('Debe suministrar las observaciones y el número de planilla');
	return;
}
...
<table width="100%" class="borde_tab"><tr><td class="titulos5"><center><b>ENVIO DE DOCUMENTOS - RADICACION MASIVA</b></center></td></tr></table>
<table><tr><td></td></tr></table>
  ...
  <tr class=listado2> 
        ...
        <td height="26" align="center" width="35%"> 
         ...
         <option selected value="null">--- empresas de envío ---</option>
		<? 
 			$a = new combo($db); 			
...
<p align="center"> 
  ...
  <span class=etexto> </span></p>
  </form>
<span class=vinculos><center>
  <a href=javascript:back1()> 
  Regresar a Listado</a> 
</center></span>

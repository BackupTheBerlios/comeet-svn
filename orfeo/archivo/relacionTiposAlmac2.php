...
$sqli="select ($conD) as detalle,sgd_eit_codigo from sgd_eit_items where sgd_eit_cod_padre='$codp'";
...
<?php
$i=1;
 	$sqm1="select * from sgd_eit_items where sgd_eit_cod_padre like '$codig'";
	...
	$sqlp="select SGD_EIT_NOMBRE,sgd_eit_cod_padre from sgd_eit_items where sgd_eit_codigo like '$codig'";

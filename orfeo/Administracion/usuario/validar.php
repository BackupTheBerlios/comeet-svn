...
?>
  	<tr>
    <td width="40%" height="26" class="listado2"> <input type="checkbox" name="digitaliza" value="$digitaliza" <? if ($digitaliza) echo "checked"; else echo "";?>>
...
?>
	...
	<tr>
		<td width="40%" height="26" class="listado2" colspan="2">
			...
			Usuario P&uacute;blico.&nbsp;&nbsp;&nbsp;Seleccione las dependencias desde las cuales ser&aacute; visible..
			<?PHP
			echo $rs_dep->GetMenu2('dep_vis[]',$arrDepSel,false,true,5,'class=select');
			?>
		</td>
	<tr>
		<td width="40%" height="26" class="listado2"> Creaci&oacute;n de expedientes.
<?
	$contador = 0;
	while($contador <= 2)
	{

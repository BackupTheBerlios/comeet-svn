<?
	...
	case 'oracle':
	case 'oci8':
		$sql="select * from SGD_ARCHIVO_CENTRAL where $srds $c $sbrds $d $pross $ef $r $b $x $a $zon $f $carro $g $cara $i $estan $h $entre $v $caja $t $orden $k $depe $l $fecha $j $fecha2 $w $fecha3 $wq $deman $n $demant $m $docu $o $inder $p $mata $q $pst $pt SGD_ARCHIVO_ID !=0 $orde";

...
{	$isqlB = "select * from sgd_tpr_tpdcumento where upper(rtrim(sgd_tpr_descrip)) = '$detatipod' "; 
	...
	{	$isql = "select max(sgd_tpr_codigo) as NUME from sgd_tpr_tpdcumento"; 
		...
		$query="insert into SGD_TPR_TPDCUMENTO(SGD_TPR_CODIGO, SGD_TPR_DESCRIP,SGD_TPR_TERMINO,SGD_TPR_TP2,SGD_TPR_TP1,SGD_TPR_TP3,SGD_TPR_TP5 )
				VALUES ('$radiNumero','$detatipod','$terminot',$flds_Entrada,$flds_Salida,$flds_Memo,$flds_Reso)";

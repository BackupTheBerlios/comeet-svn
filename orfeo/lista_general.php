...
<tr> 
    <td align="right" bgcolor="#CCCCCC" height="25" class="titulos2" >Fecha de <?=$_SESSION["descRadicado"]?></td>
...
<tr> 
  ...
  <tr> 
	...
	if (swVerSancion==1)
		//window.open('<?=$lksancion.$lkGenerico?>',"Sancionados-Sanci�n",'top=0,height=580,width=640,scrollbars=yes');

...
//	if (!defined('ADODB_DIR')) define('ADODB_DIR',dirname(__FILE__));
	...
	*/
	...
	var $numToString_func = ""; ///Función por defecto para convertir tipo de dato numérico a texto -- cambia a STR para MsSql
	var $ltrim_func = ""; /// Función para remover los espacios de la parte izaquierda de un String -- cambia a ltrim para MsSql
	...
	function &_Execute($sql,$inputarr=false)
	{
		...
		*************************/
		...
		if ($this->_queryID === false) { // error handling if query fails
			if ($this->debug == true) adodb_backtrace(true,5);	
	...
	*/
	 ...
	 * otras como MsSql necesitan una conversión explísita del campo  a texto. Esta función obtiene en nombre de la rutina
	 * de conversión para tipos numéricos 
	 *
	 * @param n	el campo numérico a convertir
	 * 
	 * Uso: $db->numToString($str1);
	 * 
	 * @return el campo con la función de conversión
	 */ 	 
	...
	{	
		...
		/**
	 * Función para remover los espacios de la parte izquierda de un tring
	 *
	 * @param s	el string a procesar
	 * 
	 * Uso: $db->ltrim($str1);
	 * 
	 * @return el string con la función de remover los espacioa a izquierda
	 */ 	 
	function ltrim($s)
	{	

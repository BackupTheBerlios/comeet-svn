...
$mdate=date('m');
// var que almacena el aï¿½ de la fecha
$adate=date('Y');
...
//---------->>		
//Adiones para DIR_E SSPD, no quieren que se reemplace DIR_R con DIR_E
		$campos = array();
		$datos  = array();
...
switch (strtoupper($ext))
{
	case 'ODT':
	{
		...
		{
			case 'W':
			define ( 'WORKDIR', '.\bodega\tmp\workDir\\' );

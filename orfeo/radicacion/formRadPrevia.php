...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="BORDE_TAB">
	<tr align="center" >
	<td class="titulos2">
	<center>VERIFICACION  PREVIA <?=$tRadicacionDesc ?>  <b>  <font  size=3 color=green>(  <?=$dependencia ?>
      -->
      <?=$tpDepeRad[$ent]?>
      )</b></font></center></td>
	</tr>
   ...
   <table width="100%" border="0" cellspacing="1" cellpadding="1" class="borde_tab">
     ...
     <tr>
       ...
       <td height="15" colspan="2" align="left" class="titulos2" >No. <?=$_SESSION["descRadicado"]?> </td>

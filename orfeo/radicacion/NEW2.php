...
if ($tip3img[3][$ent])
{
	...
	$pestana3 = "<a href='#'  onClick='pestanas(3);' class='etextomenu'><img src='../img/tip3/$imgTp3.jpg' width='110' height='25' border='0'  id=empresa $descTp3><img src='../img/tip3/".$imgTp3."S.jpg' width='110' height='25' border='0' id=empresa_R $descTp3></a>";
}

?>
<head>
<title>.:: Orfeo M&oacute;dulo de Radicaci&acuoteo;n::.</title>
...
//	echo "document.getElementById('predio').style.display = '$ver_pestana';";
	echo "document.getElementById('predio').style.display = 'none';";
...
<?if($ent==8){?>   
var dateAvailable2 = new ctlSpiffyCalendarBox("dateAvailable2", "formulario", "fechrd","btnDate2","<?=$fechrd?>",scBTNMODE_CUSTOMBLUE);
<? }?>
  </script>
   <?
...
<tr>
	...
	?>
      Modulo de Generacion de <?=$_SESSION["descRadicado"]?>  - -
      <?=$tRadicacionDesc?>
      (Dep
      <?=$dependencia ?>
      ->
...
for($i=1;$i<=3;$i++)
{
	...
	$bloqEdicion="";
	if ($i==3)	$bloqEdicion = "readonly='true'";
?>
...
<tr >
	<td width="20%" class="titulos5" height="25" align="right"><font face="Arial" class="etextomenu">
	<?=$_SESSION["descDepartamento"]?></font>
	</td>
	<td width="20%" bgcolor="#FFFFFF" height="25" class="listado5">
<?php
...
?>
	...
	<td width="20%" class="titulos5" height="25" align="right"><font face="Arial" class="etextomenu">
           <?=$_SESSION["descMunicipio"]?></font></td>
	<td  colspan="3" bgcolor="#FFFFFF" height="25" class="listado5">
<?php
...
<tr>
	...
	Palabra Clave <input type="text" name="pclave" value='<?=$pclave?>' class="tex_area" size=30>
 </font>
<?php
if($ent==2)
{
...
?>
	...
	<td width="25%" valign="top" class="listado5">
		<font color="">
<?php
...
if(!$coddepe and $ent!=8)
{
	$coddepe=$dependencia;
}
elseif(!$coddepe and $ent==8)
{
	$coddepe=999;
}
 ...
 */
if($ent==8){
      $queryWhere =" where depe_codi=999";
}
elseif($ent!=2)
{
...
if (!$Submit4 && $noRad==0)
{
	{
?>
	<center><input type='button' onClick='radicar_doc()' name='Submit33' value='<?=$_SESSION["descRadicar"]?>' class="botones_largo">
	<input type='hidden'  name='Submit3' value='<?=$_SESSION["descRadicar"]?>' class='ebuttons2'></center>
	</font>
<?php
	}
}
...
<?php
/** Aki valida si ya radico para dejar informar o Anexar archivos para ras. de Salida.
*/
if(($Submit4 or ($Submit3 and $noRad != 0)) AND !$Buscar)
{
	...
	?>
	<tr bgcolor=white>
	<td class="titulos5" align="center" valign="top">
	Informar a 
	<?

...
if(document.getElementById('radicado_salida').checked==true &&  valor!=1 && valor!=14 && valor!=16)
{
...
<div align="center">
	...
	?>
	<? if($remitente==7) $datoss4=" checked  " ;  else $datoss4 = "";?>

	<?
	if($us_1 or $us_2 or $us_3)
	{
	?>
	<?if ($radicado_salida) $datoss=" checked "; else $datoss=" ";
	$swDischekRad="";
	...
	<?php
	  ...
	  {echo " checked ";}
	 ?>' onChange="doc_radicado()" id="radicado_salida">
	Este documento ser&aacute; radicado
	<?
	}else{
	?>
...
if($borrar)
{
    $isql = "delete from sgd_dir_drecciones
	         where
			   sgd_anex_codigo='$codigo' and sgd_dir_tipo = $borrar ";
			$rs=$db->query($isql);
}
...
?>
 ...
 ?>
		<tr>
			<td class='celdaGris' align="center" colspan="2"><font size="1">&nbsp;
				</font></td>
		</tr>
	</table>
   </div>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="5" class="borde_tab">
		...
		<tr align="center"  >
			<td> <font size="-3" class="etextomenu">

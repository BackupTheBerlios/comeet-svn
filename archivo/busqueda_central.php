...
<tr><td width="20%" class='titulos2' align="left"> FECHA INICIAL &nbsp;&nbsp;&nbsp;&nbsp;  Desde  <br>&nbsp;&nbsp;&nbsp;
  ...
  ?>
          <select class="select" name="buscar_proc">
...
<td width="20%" class='titulos2' align="left"> FECHA RADICADO &nbsp;&nbsp;&nbsp;&nbsp;  Desde  <br>&nbsp;&nbsp;&nbsp;
	...
	<br>&nbsp;
	<script language="javascript">
	var dateAvailable6 = new ctlSpiffyCalendarBox("dateAvailable6", "busqueda_central", "fechaInif4","btnDate6","<?=$fechaInif3?>",scBTNMODE_CUSTOMBLUE);
...
if ($fecha!="")$orde=" order by sgd_archivo_year";
else $orde=" order by sgd_archivo_rad";
...
include("$ruta_raiz/include/query/archivo/queryBusqueda_central.php");
	...
	while(!$rs->EOF){
		...
		$fechaR=$rs->fields['SGD_ARCHIVO_FECH'];
		if($pres==1)$prest="SI";
		else $prest="NO";

...
function pintarEstadistica($fila,$indice,$numColumna)
{
	...
	switch ($numColumna){
		...
		case 2:
			...
			$datosEnvioDetalle="tipoReporte=1&amp;genDetalle=1&amp;usua_doc=".urlencode($fila['HID_USUA_DOC'])."&amp;dependencia_busq=".$_POST['dependencia_busq']."&amp;fechaIni=".$_POST['fechaIni']."&amp;fechaInif=".$_POST['fechaInif']."&amp;tipoRadicado=".$_POST['tipoRadicado']."&amp;tipoDocumento=".$_POST['tipoDocumento']."&amp;codUs=".$fila['HID_COD_USUARIO']."&amp;arch=".$_POST['arch'];

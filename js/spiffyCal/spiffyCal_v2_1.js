...
function spiffyCalManager() {
	...
	this.Holidays = new Array("Ene-1","Jul-20","Ago-7","Oct-15","Nov-5","Nov-12","Dic-8","Dic-25");
	this.HolidaysDesc = new Array("Año Nuevo","Dia Independencia","Batalla Boyacá","Día Raza","Todos los santos", "Ind. Cartagena", "Inmaculada Concepción", "Navidad");
	//*****************************************
